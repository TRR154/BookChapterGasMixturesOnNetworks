"""
This script computes and stores numerical solutions of the one-velocity model for the experiment in Section 1.6.7.

Requires: [none]

Results: numerical solutions of the one-velocity model. 
    - Stored in: save_solution/solutions/network_1v_timedep/massflowinflow

To run this script, navigate to the main directory and run 
    
    python -m numerical_experiments.section_1_6_7.script_section_1_6_7_computesolutions_1v

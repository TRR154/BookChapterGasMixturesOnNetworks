...
def plot_1v_vs_2v(prop:str,prop_name:str,unit:str,algebraic:float,net_1:Network_1v_time,
    ...
    if save_name_fig is not None:
        ...
        save_name = f"graphics/networks/1v_vs_2v/mass_in_flow_{save_name_fig}_{prop}_{int(algebraic)}"
...
def plot_all_1v_vs_2v():
    """
    plots difference of the 1v vs 2v model for mass inflow boundary conditions
    """
